...
class ViewedViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    @objc func refresh(sender: UIRefreshControl) {
        ...
        listener = postsRef.addSnapshotListener() { (querySnapshot, error) in
            ...
            self.postArray = querySnapshot!.documents.flatMap { document in
                ...
                if postData.viewed && postData.isReported == false{
                    return postData
                }
                return nil
            }
            self.postArray.sort {
                $0.viewedTime > $1.viewedTime
            }
