...
class Page1ViewController: UITableViewController,SegementSlideContentScrollViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(page1Top), name: .page1Top, object: nil)
    }
            ...
            if listener == nil {
                ...
                listener = postsRef.addSnapshotListener() { (querySnapshot, error) in
                    ...
                    self.postArray = querySnapshot!.documents.flatMap { document in
                        ...
                        if self.blockUserArray.contains(postData.uid) == true {
                            return nil
                        }else{
                            postData.id = document.documentID
                            if postData.isReported == false {
